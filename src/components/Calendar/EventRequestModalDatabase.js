...
import { X, Calendar, User, Mail, FileText, Upload, CheckCircle, XCircle } from 'lucide-react'
import { useAuth } from '../../contexts/AuthContext'
import { supabase } from '../../lib/supabase'

const EventRequestModalDatabase = ({ isOpen, onClose, selectedDate }) => {
  const { user } = useAuth()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (uploadedFile) {
        ...
        setUploadProgress('Lade Datei in Datenbank hoch...')
        ...
        console.log(`⏱️ Database upload completed in ${uploadDuration}ms`)
        ...
        console.log('✅ File uploaded to database:', uploadData[0].id)
      ...
      const requestData = {
        ...
        uploaded_mietvertrag_id: uploadedFileId,
...
export default EventRequestModalDatabase
