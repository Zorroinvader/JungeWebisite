...
import EventManagementSimple from './EventManagementSimple'
        ...
        <div className="mb-8">
          ...
          <div className="mt-4 p-4 bg-green-50 border border-green-200 rounded-md">
            <p className="text-sm text-green-800">
              ✅ Admin Panel Loaded Successfully! User: {user?.email} | Role: {profile?.role || 'No profile'}
            </p>
          </div>
        </div>
