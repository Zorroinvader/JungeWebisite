 ...
 * 
 * This configuration runs end-to-end tests against the application.
 * The base URL can be configured via TEST_BASE_URL environment variable.
 * 
 * Default: http://localhost:3000 (local dev server)
 * CI: Can be set to deployed preview URL via GitHub Actions secrets
 * 
